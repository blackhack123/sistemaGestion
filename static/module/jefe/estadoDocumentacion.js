    ...
    function gridEstadoDocumentacion(){
        ...
        $("#gridEstadoDocumentacion").jqGrid({
            url:'/grid_documentacionDirector/',
            postData: {
                csrfmiddlewaretoken : csrftoken, 
            },
            datatype: "json",
            ...
            height: 350,
            rowNum:100,
            colNames:['PROCESO', 'PROCEDIMIENTO', 'ID','NOMBRE','DESCRIPCIÓN', 'VERSION', 'id_procedimiento', 'ESTADO', 'ACCIÓN'],
            colModel: [
                ...
                { label: 'descripcion', name: 'descripcion', width: 50, sorttype:"string", align:'center', formatter: gridEstadoDocumentacion_FormatterDescripcion, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;"' }},
                ...
                /* FORMATTER SUBGRID*/
                  ...
                  function subGridDocumentacionFormatterEstadoDirector(cellvalue, options, rowObject){
                    ...
                    if(rowObject.estado_rev_director == 1){
                        ...
                        new_formatter_estadoDirector = "<a href='javascript:void(0)' onclick='modalEstadoDocumento("+id_revision+","+id_documento+");'><i class='fa fa-pencil' style='color:orange'> Aprobar</i></a>";
                    }
